...
module.exports = {
    ...
    async execute(interaction, msgEmbed) {
        let nights = ["https://c.tenor.com/6l7lYskHVDQAAAAC/baal-genshin-baal.gif", "https://i.imgur.com/Hy0cpR2.png", "https://c.tenor.com/pEykNQWTaKIAAAAC/pepe-pepo.gif", "curse"]
        img = nights[Math.floor(Math.random() * nights.length)]
        if (img === "curse") {
